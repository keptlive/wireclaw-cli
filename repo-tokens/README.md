...
```yaml
- uses: keptlive/wireclaw/repo-tokens@v1
  with:
    include: 'src/**/*.ts'
    exclude: 'src/**/*.test.ts'
```
...
| Repo | Badge |
|------|-------|
| [WireClaw](https://github.com/keptlive/wireclaw) | ![tokens](https://raw.githubusercontent.com/keptlive/wireclaw/main/repo-tokens/badge.svg) |
