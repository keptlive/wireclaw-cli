<p align="center">
  <img src="assets/wireclaw-logo.png" alt="WireClaw" width="400">
</p>
...
```bash
git clone https://github.com/keptlive/wireclaw.git
cd wireclaw
claude
```
...
Yes. WireClaw supports any Claude API-compatible model endpoint. Set these environment variables in your `.env` file:
