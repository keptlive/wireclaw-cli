...
<html><head><title>WireClaw - WhatsApp Auth</title>
...
<script>
  var startKey = 'wireclaw_qr_start';
...
<html><head><title>WireClaw - Connected!</title>
<style>
...
<script>localStorage.removeItem('wireclaw_qr_start');</script>
</body></html>`;
