...
WireClaw gives you the core functionality without that mess.
...
- Custom `wireclaw` MCP server (inside container) provides scheduling tools
...
**WireClaw** - A reference to Clawdbot (now OpenClaw).
